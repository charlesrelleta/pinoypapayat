                                          ...
                                          <form name="about" method="post" action="<?php echo base_url().'admin/update_contacts/' ?>" >
                                            ...
                                            <br/><h3 align="center" class="panel panel-success">EMAIL ADDRESS</h3>
                                                           ...
                                                           <div class="form-group"><button class="btn btn-danger" type="submit"> OK</button></div>
                                                                ...
                                                                <?php endforeach;?>
                                                                <script>
                                                                CKEDITOR.replace('editor1');CKEDITOR.replace('editor2');CKEDITOR.replace('editor3');CKEDITOR.replace('editor4');
                                                                CKEDITOR.replace('editor5');CKEDITOR.replace('editor6');CKEDITOR.replace('editor7');CKEDITOR.replace('editor8');
                                                                </script>
                                                        </div>
                                                    </div>
